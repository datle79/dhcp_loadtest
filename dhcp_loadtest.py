...
def preparePacket(xid=None, giaddr='0.0.0.0', chaddr='00:00:00:00:00:00', ciaddr='0.0.0.0', yiaddr='0.0.0.0',
                  msgtype='discover', required_opts=[]):
    req = DhcpPacket()
    req.SetOption('op', [1])
...
entered = input("Press 'Enter' key to continue...")
